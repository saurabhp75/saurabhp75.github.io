...
Hosting Flask app on pythonanywhere
    ...
    2. Upload the zipped project folder to pythonanywhere.
	...
	Later you can switch to virtual env using : $workon my-virtualenv

	location of virtual env = “/home/saurabhp75/.virtualenvs/myenv”
